...
class PrimaryChallengeCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        color: FitnessChallengesScreen.cardLight,
          ...
          Row(
            children: [
              Container(
                ...
                height: 38,
                decoration: const BoxDecoration(
                  color: FitnessChallengesScreen.lime,
                  shape: BoxShape.circle,
                ),
                child: const Icon(
                  Icons.fitness_center,
                  size: 20,
                  color: Color(0xFF2E3B00),
                ),
              ),
              ...
              const Text(
                'STRENGTH',
                style: TextStyle(
                  color: FitnessChallengesScreen.muted,
                  fontSize: 27 * 0.5,
                  fontWeight: FontWeight.w700,
                  letterSpacing: 1,
                ),
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: NetworkImage(
                      'https://i.pravatar.cc/60?img=${22 + i}',
                    ),
                    fit: BoxFit.cover,
                  ),
                ),
      ...
      child: Column(
        children: [
          Container(
            ...
            child: Icon(
              icon,
              color: active ? const Color(0xFF111714) : const Color(0xFF1E2126),
              size: 34,
            ),
          ),
      ...
      children: [
        Container(
          ...
          child: Icon(
            icon,
            size: 30,
            color: active ? const Color(0xFF233000) : const Color(0xFF8B8E81),
          ),
        ),
        const SizedBox(height: 10),
        Text(
