      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Main Circular Progress Indicator Section
            Container(
            ...
            // Grid Section: Body Mass Index & Daily Calories Tracker
            Row(
              children: [
                Expanded(
                  child: GestureDetector(
            ...
            // Grid Section: Hydration Increments & Training Status Module
            Row(
              children: [
                Expanded(
                  child: Container(
            ...
            // Meal Logging Interaction Module
            Container(
              padding: const EdgeInsets.all(16),
              margin: const EdgeInsets.only(bottom: 16),
              decoration: BoxDecoration(color: const Color(0xFF161616), borderRadius: BorderRadius.circular(4)),
            ...
            // Subscription Tracking & Premium Plans Block
            Container(
              padding: const EdgeInsets.all(16),
              margin: const EdgeInsets.only(bottom: 16),
              decoration: BoxDecoration(
            ...
            // Core CTA Workout Timer Launch Button
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
